  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-zinc-900 selection:bg-zinc-900 selection:text-white dark:bg-black dark:text-[#f7f8f8]">
      ...
      <header className="sticky top-0 z-40 border-b border-black/5 bg-white/80 backdrop-blur-xl dark:border-white/10 dark:bg-black/80">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-8">
          ...
          <div className="flex items-center gap-4">
            {/* Currency Toggle */}
            <div className="flex items-center rounded-xl border border-black/10 bg-zinc-100 p-1 dark:border-white/10 dark:bg-zinc-900">
              <button
                type="button"
            ...
            {user ? (
              ...
              <button
                ...
                className="rounded-xl bg-zinc-900 px-4 py-1.5 text-xs font-semibold text-white hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-zinc-200"
              >
                Sign In
              </button>
            )}
      ...
      <main className="mx-auto max-w-6xl px-4 py-12 sm:px-8 sm:py-20">
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-2 rounded-2xl py-3 text-sm font-bold transition ${
                    pkg.popular
        ...
        <div className="rounded-3xl border border-black/10 bg-white p-6 sm:p-8 dark:border-white/10 dark:bg-zinc-900/50 mb-20 shadow-xs">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="flex items-start gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">
            ...
            <div className="flex items-start gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20">
        ...
        {/* Credit Consumption & Rates Table */}
        <div className="mb-20">
          ...
          <div className="overflow-hidden rounded-2xl border border-black/10 bg-white dark:border-white/10 dark:bg-zinc-900/70 shadow-xs">
        ...
        <div id="policy" className="rounded-3xl border border-black/10 bg-white p-8 sm:p-12 dark:border-white/10 dark:bg-zinc-900/60 shadow-xs mb-16">
        ...
        <div className="max-w-3xl mx-auto mb-16">
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-black/10 bg-white p-5 dark:border-white/10 dark:bg-zinc-900/60 shadow-xs">
