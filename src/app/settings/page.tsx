...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0c0c0c] text-slate-900 dark:text-slate-100 py-10 px-4 sm:px-6 lg:px-8 transition-colors duration-200">
      <div className="max-w-3xl mx-auto">
        {/* Navigation Bar with Back, Theme Toggle, and Credits */}
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-5">
          <button
            type="button"
            onClick={handleBack}
            className="inline-flex items-center gap-2 text-xs font-semibold text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition cursor-pointer"
          >
            <ArrowLeft className="h-4 w-4" />
            <span>Back</span>
          </button>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              type="button"
              onClick={toggleTheme}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 text-xs font-semibold shadow-2xs transition"
            ...
            <div className="flex items-center gap-1.5 rounded-full border border-blue-200 bg-blue-50/90 dark:border-blue-900/50 dark:bg-blue-950/40 px-3 py-1.5 text-xs font-bold text-blue-700 dark:text-blue-300">
        ...
        <div className="py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3.5">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-600 text-white text-base font-bold shadow-xs">
              {(user.name || user.email || 'U').charAt(0).toUpperCase()}
            </div>
            <div>
              <h1 className="text-xl font-extrabold text-slate-900 dark:text-white">{user.name || user.email || 'User'}</h1>
          ...
          {/* Tab Switcher */}
          <div className="flex rounded-xl border border-slate-200 bg-slate-100 dark:border-slate-800 dark:bg-slate-900 p-1">
            <button
              type="button"
            ...
            >
              ...
              <span className={`rounded-full px-1.5 py-0.2 text-[10px] font-bold ${activeTab === 'referrals' ? 'bg-black/20 text-slate-950' : 'bg-amber-500/10 text-amber-600 dark:text-amber-400'}`}>
                +10
              </span>
            </button>
          </div>
        ...
        {/* Section Content */}
        <div className="mt-2 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#111111] p-6 sm:p-8 shadow-sm">
          {activeTab === 'profile' && (
